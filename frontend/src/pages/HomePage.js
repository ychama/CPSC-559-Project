...
const HomePage = () => {
  ...
  const testJson = '{"canvasName":"Thomas\' Canvas", participants:4, capacity:5, thumbNail:"https://uploads.theartofeducation.edu/flex/lesson_plans/recN3XJX9okThbftu/927253c0" }';
